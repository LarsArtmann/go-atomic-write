...
- **Copy buttons are declarative** — `website/public/js/copy-code.js` binds every `[data-copy]` element, not a single `#copy-btn`. A new copyable snippet needs only `data-copy` plus `data-code={...}`.
