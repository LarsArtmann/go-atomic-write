...
- **Lighthouse CI** — `website/lighthouserc.json` with performance/accessibility/SEO budgets (desktop preset), `@lhci/cli` devDependency, `npm run lighthouse` script, and `chromium` in the Nix devShell (`CHROME_PATH` set). Verified: Performance 100, Accessibility 100, Best-Practices 96, SEO 100.
